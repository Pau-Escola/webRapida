...
function HeroBanner() {
    ...
    return (
        <div className="relative h-[400px] md:h-[500px] lg:h-[800px] w-full">
            <Carousel images={[cotenidor1, cotenidor2, casetaJetSKi, casetaControl, casetaControl2, reparacioCantera]} size="absolute inset-0 w-full h-full" objectFit={"object-cover"} />
