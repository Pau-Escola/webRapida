    ...
    return (
        <div className="relative h-[400px] md:h-[500px] lg:h-[800px] w-full">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white space-y-4 bg-black bg-opacity-60">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">Benvingut a SIM</h1>
                <p className="text-sm sm:text-md md:text-lg lg:text-xl max-w-2xl">Una experiència de 20 anys d'especialització en tot tipus de solucions prefabricades: temporals o definitives, en lloguer o venda, noves o d'ocasió, fan del <b>GRUP SIM</b> una resposta en la construcció mòbil i edificació modular.
